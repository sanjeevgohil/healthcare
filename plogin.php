...
<body bgcolor="white" text = "Arial">
	...
	<form method="POST" action="ploginpro.php" style=" padding-top:70px;padding-bottom:70px;padding-left:100px;padding-right:100px;">
	...
	<h1 align="center">Patient Login</h1>
		...
		<tr style="width:100%">
				...
				<style="width:50%" align="left"><a href="pforgotpass.php"><input type="button" name="Forgot password" value="Forgot Password"></a>
