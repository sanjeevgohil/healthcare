...
<body bgcolor="white" text = "Arial">
	...
	<h1 align="center">Doctor Registration</h1>
		...
		<tr style="width:100%">
				...
				<select name="spe">
					<?php
						...
						{
							echo "<option  value='".$r[1]."' name='spe'>".$r[1]."</option>";	
						}
					?>
				</select>
		</tr><tr></tr><tr></tr>
		...
		<tr style="width:100%">
				...
				<td style="width:50%" align="left"><input type="text" name="edu" placeholder="Enter Qualification Hear" required size=30></td>
		</tr><tr></tr><tr></tr>

		<tr style="width:100%">
				<td style="width:50%; height:50px" align="Left"><h2><font color=#000000>Experience  :</font></h2></td>
				<td style="width:50%" align="left"><input type="text" name="exp" placeholder="Enter Experience Hear" required size=30></td>
		</tr><tr></tr><tr></tr>
